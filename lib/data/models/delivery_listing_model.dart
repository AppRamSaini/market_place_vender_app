...
//
//     final deliveryListingModel = deliveryListingModelFromJson(jsonString);

import 'dart:convert';

DeliveryListingModel deliveryListingModelFromJson(String str) => DeliveryListingModel.fromJson(json.decode(str));

String deliveryListingModelToJson(DeliveryListingModel data) => json.encode(data.toJson());

class DeliveryListingModel {
  bool? status;
  int? code;
  String? message;
  Data? data;

  DeliveryListingModel({
    this.status,
    this.code,
    this.message,
    this.data,
  ...
  factory DeliveryListingModel.fromJson(Map<String, dynamic> json) => DeliveryListingModel(
    status: json["status"],
    code: json["code"],
